...
def dec():
    ...
    # sliders = layers.Dense(3+4+3+2+9+3+3+4+3+3+2+1+1, name='sliders',activation="tanh")(x)
    ...
    # model = tf.keras.Model(inputs,(sliders,gender,skintone,headshape_preset,headshape_refine_dir,
    #                                 eyes_mix,eye_colour,eyebrows_preset,
    #                                 forehead_mix,nose_mix,
    #                                 ears_mix,cheeks_mix,mouth_mix,
    #                                 jaw_mix,chin_mix,neck_mix,
    #                                 ff1_preset,ff2_preset),name="Decoder")
